...
# Los enteros y los decimales son polimorficos son respecto a la suma
4 + 6
4.5 + 5.7
...
# Pero por ejemplo los enteros no son polimorficos con respecto a la funcion factorial
math.factorial(4)    # 24
