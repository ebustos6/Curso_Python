...
a_list[1]  # 7.5
a_list[2]  # 'Hola'
a_list[-1] # [1, 2] --> cuando se pone numero negativo arranca desde el ultimo
...
# Devulve la cantidad de elementos de la lista
len(a_list) #5
...
a_list.count(3)
# Elimina el primer elemento que encuentra pasado como parametro
a_list.remove(3)
# Hace una copia superficial de la lista
a_list_copy = a_list.copy()
# Saca el ultimo elemento y lo devuelve
a_list.pop()
# Saca el tercer elemento de la lista y lo devuelve
a_list.pop(3)
